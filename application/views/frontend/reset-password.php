  ...
  <div class="container">
      ...
      <div class="contact-us register">
        <div class="bg-text">
          ...
          <form role="form" class="validate registerForm" method="post" action="<?php echo base_url($lang.'/resestCustomerPass'); ?>">
            <?php
            ...
            <div class="form-group">
              <input type="password" class="form-control" placeholder="OLD PASSWORD" value="<?php echo set_value('old_password'); ?>" name='old_password' />
            </div>
            <div class="form-group">
