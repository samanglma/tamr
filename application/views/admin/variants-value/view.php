   ...
   <section class="content">
       <div class="page-heading">
           <h1>Variants Value</h1>
           <ol class="breadcrumb">
               <li><a href="javascript:void(0);">Home</a></li>
               <li><a href="javascript:void(0);">Tables</a></li>
               <li class="active">Variants Value List</li>
           </ol>
       </div>
       <div class="page-body">
           <div class="panel panel-default">
               <div class="panel-heading">Variants Value List</div>
                       ...
                       <tr>
                           ...
                           <td width="">
                               <div class="btn-group">
                                   ...
                                   <a href="<?php echo base_url()?>admin/variant_value/delete/<?php echo $row->id;?>"> <button class="btn btn-danger btn-xs" Onclick="return ConfirmDelete()">Delete</button></a>
                               </div>
                           </td>
                       </tr>
                       <?php } ?>
