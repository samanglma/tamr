       ...
       <div class="page-body clearfix">
           ...
           <div class="panel panel-default">
               ...
               <div class="panel-body">
                   ...
                   <form method="post" action="<?php echo base_url()?>admin/delivery_charges/save" enctype="multipart/form-data">

				    <div class="col-md-7 form-group">
                               <label>States *</label>
                               <select name="state_id[]" class="form-control js-example-basic-multiple" multiple="multiple" required>
                       ...
                       <div class="col-md-7  form-group">
                           ...
                           <input type="text" name="min_amount" value="<?= set_value('min_amount') ?>" class="form-control" placeholder="Charges Amount" />
