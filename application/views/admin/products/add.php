       ...
       <div class="page-body clearfix">
           ...
           <div class="panel panel-default">
               ...
               <div class="panel-body">
                ...
                <select name="child_cat" class="form-control" >
                       ...
                       <div class="col-md-7  form-group">
                           ...
                           <input type="text" name="title"  value="<?php if(empty(set_value('title')) && isset($data)){ echo $data['data']['title']; } else { echo set_value('title'); } ?>" class="form-control" placeholder="Title" required />
                           <?php echo form_error('title', '<div class="error" style="color: red;">', '</div>'); ?>
                       </div>

                       <div class="col-md-7  form-group">
                           <label>Arabic Product Name</label>
                           <input dir="rtl" type="text" name="title_ar" value="<?php if(empty(set_value('title_ar')) && isset($data)){ echo $data['data']['title_ar']; } else { echo set_value('title_ar'); } ?>" class="form-control" placeholder="Arabic Tite" />
                       </div>

                       <div class="col-md-12 form-group">
                           <label>Description</label>
                           <textarea class="ckeditor1" name="description" id="editor"> <?php if(empty(set_value('description')) && isset($data)){ echo $data['data']['description']; } else { echo set_value('description'); } ?> </textarea>
                       </div>

                       <div class="col-md-12 form-group">
                           <label>Arabic Description</label>
                           <textarea class="editor1" dir="rtl" maxlength="30" name="description_ar" id="editor_ar"> <?php if(empty(set_value('description_ar')) && isset($data)){ echo $data['data']['description_ar']; } else { echo set_value('description_ar'); } ?> </textarea>
                       </div>

                       <div class="col-md-7  form-group">
                           <label>Price *</label>
                           <input type="text" name="price"  value="<?php if(empty(set_value('price')) && isset($data)){ echo $data['data']['price']; } else { echo set_value('price'); } ?>" class="form-control" placeholder="Price"  required />
                           <?php echo form_error('price', '<div class="error" style="color: red;">', '</div>'); ?>
                       </div>

                       <div class="col-md-7  form-group">
                           <label>Price <small>(Including VAT)</small>*</label>
                           <input type="text" name="vat_price"  value="<?php if(empty(set_value('vat_price')) && isset($data)){ echo $data['data']['vat_price']; } else { echo set_value('vat_price'); } ?>" class="form-control" placeholder="Price (Including VAT)"  required />
                      ...
                      <div class="col-md-7  form-group">
                       ...
                       <div class="col-md-7  form-group">
                           <label>Alt *</label>
                           <input type="text" name="alt" value="<?php if(empty(set_value('alt')) && isset($data)){ echo $data['data']['alt']; } else { echo set_value('alt'); } ?>" class="form-control" placeholder="Alt Tag"  required/>
               ...
               <div class="form-check">
                 <input class="form-check-input" type="checkbox" name="variants[]" id="chkPassport" value="<?php echo $variant->id; ?>">
