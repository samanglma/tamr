                   ...
                   <form method="post" action="<?php echo base_url()?>admin/products/update" enctype="multipart/form-data">
                       ...
                       <div class="col-md-7 form-group">
                               ...
                               <?php foreach($brands as $brand){?>
                                   <option value="<?php echo $brand->id ?>" <?php if($brand->id == $row->brand_id){ echo "selected"; }?>><?php echo $brand->brand_name; ?></option>
                                <?php } ?>
                               </select>
                       </div>
                       ...
                       <div class="col-md-12 form-group">
                           ...
                           <textarea class="ckeditor1" name="description" id="editor"> <?php echo $row->description ?> </textarea>
                       </div>

                       <div class="col-md-12 form-group">
                           <label>Arabic Description</label>
                           <textarea class="editor1" dir="rtl" name="description_ar" id="editor_ar"> <?php echo $row->description_ar ?> </textarea>
                       </div>
             ...
             <?php } ?>
					   ...
					   <div class="col-md-7  form-group">
						  ...
						  <div class="form-check form-check-inline">
							   <input class="form-check-input" type="radio" name="markAsNew" id="markAsNew" <?php if($row->mark_as_new==1){echo 'checked';}  ?> value="1">
							   <label class="form-check-label" for="inlineRadio1">Yes</label>
						   </div>
						   <div class="form-check form-check-inline">
							   <input class="form-check-input" type="radio" name="markAsNew" id="markAsNew2" <?php if($row->mark_as_new!=1){echo 'checked';}  ?>  value="0">
					   ...
					   <div class="col-md-7  form-group" >
						   ...
						   <div class="form-check form-check-inline">
							   <input class="form-check-input" type="radio" name="topSeller" id="topSeller" <?php if($row->top_seller==1){echo 'checked';}  ?>  value="1">
							   <label class="form-check-label" for="inlineRadio1">Yes</label>
						   </div>
						   <div class="form-check form-check-inline">
							   <input class="form-check-input" type="radio" name="topSeller" id="topSeller2" <?php if($row->top_seller!=1){echo 'checked';}  ?> value="0">
							   <label class="form-check-label" for="inlineRadio2">No</label>
						   </div>
                       </div>
                       <div class="col-md-7  form-group" >
						   ...
						   <div class="form-check form-check-inline">
							   <input class="form-check-input" type="radio" name="outofStock" id="outofStock" <?php if($row->out_of_stock==1){echo 'checked';}  ?> value="1">
							   <label class="form-check-label" for="outofStock">Yes</label>
						   </div>
						   <div class="form-check form-check-inline">
							   <input class="form-check-input" type="radio" name="outofStock" id="outofStock2" <?php if($row->out_of_stock!=1){echo 'checked';}  ?> value="0" >
