               ...
               <div class="panel-body">
                   ...
                   <form method="post" action="" enctype="multipart/form-data">
                       ...
                       <div class="col-md-7  form-group">
                           <label>Code  *</label>
                           <input type="text" name="code"  value="<?php if(empty(set_value('code')) && isset($data)){ echo $data['data']['code']; } else { echo set_value('code'); } ?>" class="form-control" maxlength="12" placeholder="Code" required />
                       ...
                       <div class="col-md-7  form-group">
                           ...
                           <input type="text" name="expire_at" value="<?php if(empty(set_value('expire_at')) && isset($data)){ echo $data['data']['expire_at']; } else { echo set_value('expire_at'); } ?>" class="form-control expire_at" maxlength="" placeholder="Expiry Date" required />
                           <?php echo form_error('expire_at', '<div class="error" style="color: red;">', '</div>'); ?>
                       </div>

                       <div class="col-md-7  form-group">
                           <label>Usage<small> (Leave blank for unlimited)</small></label>
                           <input type="number" name="usage"  value="<?php if(empty(set_value('usage')) && isset($data)){ echo $data['data']['usage']; } else { echo set_value('usage'); } ?>" class="form-control" placeholder="Usage"  />
