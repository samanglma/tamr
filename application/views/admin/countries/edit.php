       ...
       <div class="page-body clearfix">
           ...
           <div class="panel panel-default">
               ...
               <div class="panel-body">
                   ...
                   <form method="post" action="<?php echo base_url()?>admin/countries/update" enctype="multipart/form-data">
                       ...
                       <button type="submit" class="btn btn-sm btn-success pull-left">Save</button>
                           &nbsp;&nbsp;
                           <a href="<?php echo base_url()?>admin/countries" type="submit" class="btn btn-sm btn-danger">Cancel</a>
                       </div>
                   </form>
               </div>
           </div>
