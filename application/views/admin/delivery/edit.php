    ...
    <div class="page-body clearfix">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form method="post" action="<?php echo base_url() ?>admin/delivery/edit/<?= $row->ID ?>" enctype="multipart/form-data">
                    ...
                    <div class="col-md-7  form-group">
                        <label>Amount *</label>
                        <input type="number" name="delivery_charges" value="<?= set_value('delivery_charges') != '' ? set_value('delivery_charges') : $row->delivery_charges ?>" class="form-control" placeholder="Add delivery charges" required />
                    ...
                    <div class="col-md-7  form-group">
                        ...
                        <input type="number" name="min_duration" value="<?= set_value('min_duration') != '' ? set_value('min_duration') : $row->min_duration ?>" required class="form-control" placeholder="Add Minimum duration of delivery (Hours)" />
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                $.each(data, function(index, value) {
                    $selected = value.ID == <?= $row->city_id ?> ? 'selected' : '';
